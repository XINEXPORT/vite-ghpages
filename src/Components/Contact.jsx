...
//   };
  ...
  return (
    ...
    <section className = {`${styles.flexCenter} flex flex-col sm:min-h-screen`}>
      ...
      <div id='contactBody' className={`${styles.paddingX} text-[22px]`}>


        <div id='section1' className={`flex flex-col md:flex-row justify-start items-center relative p-4 prose text-[18px]`}> 
          
          <div id='contactimage' className=''>
            <img src={cowgirl} alt='' className='max-w-[300px] w-full '/>
          </div>

          <div id='contacttext' className='w-[480px]'>

                <p className =' text-center flex justify-center items-center '> Got something to say, partner? Drop us a line! Feel free to DM or add us to stay connected. 
                </p>
        ...
        <div id='section3' className={`flex flex-col items-center py-20 relative prose text-[18px]`}>
